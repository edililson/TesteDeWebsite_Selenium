...
public class AbrirSite {
	...
	public void test() throws InterruptedException {
		...
		String verificar_alerta = driver.findElement(By.className("alert-danger")).getText();// pegando o valor do alerta 
		assertEquals("Usuário ou senha inválidos!", verificar_alerta);// verificando se o valor esperado é o mesmo que o valor contido
		
		boolean verificar = driver.findElement(By.className("alert-danger")).isEnabled();// verificando se o alerta de ususário invalido foi exibido
